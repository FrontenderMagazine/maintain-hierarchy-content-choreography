...
последовательностью контента, не ограниченной исходной последовательностью в
...
Вот три спецификации, которые мы скорее всего будем использовать в скором 
времени:
...
**Opera mini и IE младше 10-ой версии не поддерживают ни один из синтаксисов
...
В отличие от проблемы исходной последовательности, для перемешивания контента
...
как выглядит макет со всем содержимым, представленным в одной колонке. Слева
